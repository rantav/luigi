...
class RedshiftTarget(luigi.postgres.PostgresTarget):
  """
  ...
  def __init__(self, host, database, user, password, table, update_id):
    ...
    """
    luigi.postgres.PostgresTarget.__init__(self, host, database, user,
                                           password, table, update_id)
...
class CopyToTable(luigi.postgres.CopyToTable):
  """
  ...
  def copy_attributes(self):
    '''Add extra copy attributes, for example:
